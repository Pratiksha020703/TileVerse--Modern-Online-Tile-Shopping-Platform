...
import { sendContact } from "../api/ecommerceApi";
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-7 mb-4">
              <div className="card shadow-sm border-0 h-100">
                <div className="card-body">
                  <h4 className="fw-bold mb-4 text-coral">Send Us a Message</h4>
                  ...
                  <form onSubmit={submit}>
                    ...
                    <button type="submit" className="btn btn-coral px-4">
                      Send Message
                    </button>
                  </form>
                </div>
            ...
            <div className="col-md-5 mb-4">
              <div className="card shadow-sm border-0 h-100">
                <div className="card-body">
                  <h4 className="fw-bold mb-4 text-coral">Get in Touch</h4>
